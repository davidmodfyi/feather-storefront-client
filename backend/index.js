...
// Initialize homepage configuration table
function initializeHomepageConfigTable() {
  try {
    db.prepare(`
    ...
    // Create default configurations for existing distributors
    ...
    console.log('Homepage configuration table initialized');
  } catch (error) {
    console.error('Error initializing homepage configuration table:', error);
  }
}
...
app.post('/api/homepage-config', (req, res) => {
  ...
  try {
    ...
    console.log('💾 Homepage config saved successfully');
